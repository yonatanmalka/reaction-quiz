...
import UserInfo from './Payments/UserInfo';
import PaymentCard from './Payments/PaymentCard';
import Advanteges from './Payments/Advanteges';

export default function Payment({ attributes } : { attributes: any }) {

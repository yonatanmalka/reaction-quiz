        ...
        <div>
            ...
            <div className="yesCardDiv">
                ...
                >
                    ...
                    <div className="text-[#343434] font-semibold text-[16px] md:text-[20px] mt-[5px]">Disagree</div>
                </div>
                <div
                ...
                >
                    ...
                    <div className="text-[#343434] font-semibold text-[16px] md:text-[20px] mt-[5px]">Agree</div>
                </div>
            </div>
        </div>
    );
